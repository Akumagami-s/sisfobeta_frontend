...
const allDataEbaltab = {
  ...
  datasets: [
    {
      label: 'Dataset 1',
      data: [0, 2000, 4000, 2000,3000,4000,4500,6000,6000,5000,4000,3000],
      borderColor: '#FF832A',
    ...
    },
    {
      label: 'Dataset 2',
      backgroundColor: 'transparent',
      data: [2500, 3000, 3000, 6000,5000,7000,6000,5000,4000,2000,4000,5000],
      borderColor: '#7334FF',
      tension: 0.4,
      borderWidth :3,
    },
    {
      label: 'Dataset 3',
      data: [2000, 1000, 6000, 3000,6000,4000,2000,6000,8000,5000,6000,7000],
      borderColor: '#DC3545',
      backgroundColor: 'transparent',
      tension: 0.4,
      borderWidth :3,
